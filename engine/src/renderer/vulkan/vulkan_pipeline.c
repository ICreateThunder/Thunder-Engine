...
b8 vulkan_graphics_pipeline_create(
    ...
    // Rasteriser
    VkPipelineRasterizationStateCreateInfo rasteriser_create_info = {VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO};
    rasteriser_create_info.depthClampEnable = VK_FALSE;
    rasteriser_create_info.rasterizerDiscardEnable = VK_FALSE;
    rasteriser_create_info.polygonMode = is_wireframe ? VK_POLYGON_MODE_LINE : VK_POLYGON_MODE_FILL;
    ...
    kzero_memory(&colour_blend_attachment_state, sizeof(VkPipelineColorBlendAttachmentState));
    ...
    colour_blend_attachment_state.srcAlphaBlendFactor = VK_BLEND_FACTOR_SRC_ALPHA;
    colour_blend_attachment_state.dstAlphaBlendFactor = VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA;
    ...
    VkPipelineColorBlendStateCreateInfo colour_blend_state_create_info = {VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO};
    ...
    KERROR("vkCreateGraphicsPipelines failes with %s", vulkan_result_string(result, true));
    return false;
}
