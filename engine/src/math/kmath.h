...
#define K_ONE_OVER_TWO_PI (2.0f / K_PI)
...
/**
 * @brief Creates and returns a new 2-component vector with all components set to 0.0f
 */
...
/**
 * @brief Creates and returns a new 2-component vector with all components set to 1.0f
 */
...
/**
 * @brief Creates and returns a new 2-component vector pointing up (0, 1)
 */
...
/**
 * @brief Creates and returns a new 2-component vector pointing down (0, -1)
 */
...
/**
 * @brief Creates and returns a new 2-component vector pointing left (-1, 0)
 */
...
/**
 * @brief Creates and returns a new 2-component vector pointing right (1, 0)
 */
...
/**
 * @brief Adds vector_1 to vector_0 and returns copy of result
 *
...
/**
 * @brief Subtracts vector_1 to vector_0 and returns copy of result
 *
 * @param vector_0 The first vector
 * @param vector_1 The second vector
 * @return The resulting vector
...
/**
 * @brief Multiplies vector_1 to vector_0 and returns copy of result
 *
 * @param vector_0 The first vector
 * @param vector_1 The second vector
 * @return The resulting vector
...
/**
 * @brief Divides vector_1 to vector_0 and returns copy of result
 *
 * @param vector_0 The first vector
 * @param vector_1 The second vector
 * @return The resulting vector
 ...
 *
 * @param vector The vector to retrive the squared length of
 * @return The sqaured length
 */
...
/**
 * @brief Normalise the provided vector in place to a unit vector
 *
 * @param vector A pointer to the vector to be normalised
 */
KINLINE void vec2_normalise(vec2* vector) {
...
/**
 * @brief Returns a normalised copy of the supplied vector
 *
 * @param vector Thr vector to be normalised
 * @return A normalised vector copy of the supplied vector
 */
KINLINE vec2 vec2_normalised(vec2 vector) {
    vec2_normalise(&vector);
    return vector;
}

/**
 * @brief Compares all elements of vector_0 and vector_1 to ensure the difference is less than tolerance
 *
 * @param vector_0 The first vector
 * @param vector_1 The second vector
...
/**
 * @brief Returns a new vec43containing the x, y, and z components of the supplied vec4
 * 
...
/**
 * @brief Returns a new vec4 containing the x, y, and z components of the supplied vec3 and the w component
 * 
 * @param vector The 4-component vector to extract from
 * @param w The w value
 * @return A new vec3
...
/**
 * @brief Creates and returns a new 3-component vector pointing up (0, 1, 0)
 */
...
/**
 * @brief Creates and returns a new 3-component vector pointing down (0, -1, 0)
 */
...
/**
 * @brief Creates and returns a new 3-component vector pointing left (-1, 0, 0)
 */
...
/**
 * @brief Creates and returns a new 3-component vector pointing right (1, 0, 0)
 */
...
/**
 * @brief Creates and returns a new 3-component vector pointing forward (0, 0, -1)
 */
...
/**
 * @brief Creates and returns a new 3-component vector pointing backward (0, 0, 1)
 */
...
/**
 * @brief Multiplies all elements of vector_0 by scalar and returns result as copy
 *
 * @param vector_0 The first vector
...
/**
 * @brief Normalises the provided vector in place to a unit vector
 *
 * @param A pointer to the vector to be normalised
 */
KINLINE void vec3_normalise(vec3* vector) {
 ...
 * @brief Returns a normalised copy of the supplied vector
 *
 * @param The vector to be normalised
 * @return A normalised copy of the supplied vector
 */
KINLINE vec3 vec3_normalised(vec3 vector) {
    vec3_normalise(&vector);
    return vector;
}
...
/**
 * @brief Returns a new vec3 containing the x, y, and z components of the supplied vec4
 * 
 * @param vector The 4-component vector to extract from
 * @return A new vec3
 */
...
/**
 * @brief Returns a new vec4 containing the x, y, and z components of the supplied vec4
 * 
 * @param vector The 3-component vector to extract from
 * @param w The w value
 * @return A new vec4
 */
...
/**
 * @brief Creates and returns a new 4-component vector with all components set to 0.0f
 */
...
/**
 * @brief Creates and returns a new 4-component vector with all components set to 1.0f
 */
 ...
 * @param A pointer to the vector to be normalised
 */
KINLINE void vec4_normalise(vec4* vector) {
 ...
 * @return A normalised copy of the supplied vector
 */
KINLINE vec4 vec4_normalised(vec4 vector) {
    vec4_normalise(&vector);
    return vector;
}
...
KINLINE quat quat_normalise(quat q) {
...
KINLINE quat quat_inverse(quat q) {
    return quat_normalise(quat_conjugate(q));
}
...
KINLINE f32 quat_dot(quat q_0, quat q_1) {
    return q_0.x * q_1.x + q_0.y * q_1.y + q_0.z * q_1.z; 
}

KINLINE mat4 quat_to_mat4(quat q) {
    mat4 out_matrix = mat4_identity();

    quat n = quat_normalise(q);
...
KINLINE quat quat_from_axis_angle(vec3 axis, f32 angle, b8 normalise) {
...
KINLINE quat quat_slerp(quat q_0, quat q_1, f32 percentage) {
    ...
    quat v0 = quat_normalise(q_0);
    quat v1 = quat_normalise(q_1);
